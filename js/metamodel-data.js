'use strict';
/* ============================================================
 * FRIPP-Pro Formal Metamodel Definition
 *
 ...
 *   FRIPP          — Shaked et al. 2023 (main paper), FRIPP.ecore
 *   SYMBIOSIS      — symbiosisDM.ecore (measurement framework)
 *
 * Metamodel version: 1.2
 *   v1.0 — initial FRIPP/PROVE/DM implementation
...
const FRIPP_METAMODEL = {
  name: 'FRIPP-Pro Metamodel',
  version: '1.2',
  description:
    'Metamodel for Operations-Informed Incident Response Playbook Planning (FRIPP). ' +
  ...
  packages: [
      ...
      classes: [
        {
          name: 'Process',
          abstract: true,
          description: 'Abstract base class for all activities. Extended by FRIPP PlaybookProcess.',
          attributes: [
            { name: 'id',        type: 'String',      mult: '1',    desc: 'UUID.' },
    ...
    {
      name:  'FRIPP',
      label: 'FRIPP (Playbook)',
      source: 'Shaked et al. 2023 (main paper) / FRIPP.ecore',
      color:  '#1e1000',
      border: '#f39c12',
      description:
